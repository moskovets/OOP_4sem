...
const char CFileError::defaultMsg[]   = "Error file ";
...
CFileError::CFileError() : CBaseException(defaultMsg) {}

CFileError::CFileError(char* addmsg) : CBaseException(defaultMsg, addmsg) {}

CFileError::CFileError(const std::string &addmsg) : CBaseException(defaultMsg, addmsg.c_str()) {}
